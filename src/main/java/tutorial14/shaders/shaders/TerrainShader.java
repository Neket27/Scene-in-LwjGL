package tutorial14.shaders.shaders;

import org.joml.Matrix4f;
import tutorial14.entities.Camera;
import tutorial14.entities.Light;
import tutorial14.shaders.toolbox.Maths;

public class TerrainShader extends ShaderProgram {

    // указываем пути в константы для загрузки шейдеров
    private static final String VERTEX_FILE = "src/main/java/tutorial14/shaders/terrainVertexShader.txt";
    private static final String FRAGMENT_FILE = "src/main/java/tutorial14/shaders/terrainFragmentShader.txt";
